...
sync_block failure-investigation "$HOME/.codex/AGENTS.md"
sync_block framework-respect "$HOME/.codex/AGENTS.md"
sync_block self-improvement "$HOME/.codex/AGENTS.md"
sync_block workspace-hygiene "$HOME/.codex/AGENTS.md"
sync_block markdown-rules "$HOME/.codex/AGENTS.md"
sync_block markdown-rules "$HOME/.claude/rules/markdown.md"
